...
from test_models.hashpass import HashedPasswordMixin, hash_password_before_change_listener
from test_models.slugify import Slugify, slugify_before_insert_listener
